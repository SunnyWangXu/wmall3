package com.wjhgw.business.sqlite;
...
public class DatabaseHelper extends SQLiteOpenHelper// 继承SQLiteOpenHelper类
{
    ...
    public DatabaseHelper(Context context)
    {
        ...
        Log.d("Hello DB", "DatabaseHelper Constructor");
    ...
    public void onCreate(SQLiteDatabase db)
    {
        ...
        Log.d("Hello DB", "DatabaseHelper onCreate");
        ...
        sBuffer.append("[goods_name] TEXT,");
        sBuffer.append("[age] INTEGER,");
        sBuffer.append("[goods_id] TEXT)");
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion)
    {
        ...
        Log.d("Hello DB", "DatabaseHelper onUpgrade");
    ...
    public void onOpen(SQLiteDatabase db)
    {
        ...
        Log.d("Hello DB", "DatabaseHelper onOpen");
    }
