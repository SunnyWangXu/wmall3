 ...
 * 商品详情赠送单人Activity
 */
public class J6_DetailGiveOneActivity extends BaseActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_detail_give_one);
    ...
    public void onFindViews() {
        ivDetailImg = (ImageView) findViewById(R.id.iv_detail_give_image);
        tvGoodsName = (TextView) findViewById(R.id.tv_detail_give_goodsname);
        tvGoodsPrice = (TextView) findViewById(R.id.tv_detail_give_goodsprice);
        tvGoodsNum = (TextView) findViewById(R.id.tv_detail_give_goodsnum);
        tvDetailGiveTotal = (TextView) findViewById(R.id.tv_detail_give_total);
